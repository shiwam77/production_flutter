...
class CheckOut extends StatelessWidget {
  ...
  final DocumentSnapshot organisation;
  const CheckOut(
      {Key? key,
            ...
            authService.checkout.doc().set({
              ...
              'organisation_detail': {
                ...
                'price': {
                  ...
                  'Kitchen_waste': organisation['price']['Kitchen_waste'],
                }
              }
            }).then((value) {
          ...
          Card(
            ...
            child: Padding(
              ...
              child: ListTile(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        Text(
                          "Kitchen_waste :${widget.organisation['price']['Kitchen_waste']}rs/kg",
                          style: TextStyle(fontSize: 12),
                        ),
                      ],
                    ),
                ...
                trailing: Image.network(widget.organisation['image']),
              ),
            ),
          ),
          Expanded(
