...
class PaperWaste extends StatelessWidget {
  final PickedFile image;
  const PaperWaste({Key? key, required this.image}) : super(key: key);
...
class PaperBody extends StatelessWidget {
  final PickedFile image;
  const PaperBody({Key? key, required this.image}) : super(key: key);
