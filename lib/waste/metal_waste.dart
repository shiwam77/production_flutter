...
class MetalWaste extends StatelessWidget {
  ...
  const MetalWaste({Key? key, required this.image}) : super(key: key);
...
class MetalWasteBody extends StatelessWidget {
  final PickedFile image;
  const MetalWasteBody({Key? key, required this.image}) : super(key: key);
  @override
  Widget build(BuildContext context) {
