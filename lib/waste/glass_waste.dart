...
class GlassWaste extends StatelessWidget {
  ...
  const GlassWaste({Key? key, required this.image}) : super(key: key);
...
class GlassWasteBody extends StatelessWidget {
  final PickedFile image;
  const GlassWasteBody({Key? key, required this.image}) : super(key: key);
  @override
  Widget build(BuildContext context) {
