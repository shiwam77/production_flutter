...
class KitchenWaste extends StatelessWidget {
  final PickedFile image;
  const KitchenWaste({Key? key, required this.image}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFF89cc4f).withOpacity(0.8),
      body: KitchenWasteBody(
        image: image,
      ),
    );
  }
...
class KitchenWasteBody extends StatelessWidget {
  final PickedFile image;
  const KitchenWasteBody({Key? key, required this.image}) : super(key: key);
  @override
  Widget build(BuildContext context) {
